...
public class VoyagerDataSource {
    ...
    @Bean(name = "voyagerJdbcTemplate")
	public JdbcTemplate postgresJdbcTemplate(@Qualifier("voyagerDatasource") 
                                              DataSource voyagerdb) {
		return new JdbcTemplate(voyagerdb);
	}
}
